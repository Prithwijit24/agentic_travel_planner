    ...
    "Kyoto": [
        {
            ...
            "history": "Iconic Shinto shrine famous for its thousands of vermilion torii gates winding up Mount Inari. Founded in 711 AD.",
            "opening_hours": "06:00",
            "closing_hours": "18:00",
            "best_time": "Morning 06:00-08:30",
            "description": "A breathtaking tunnel of thousands of red gates winding through a forested mountainside.",
            "slot": "morning",
            "lat": 34.9671,
            "lon": 135.7727,
        },
        {
            ...
            "history": "Zen Buddhist temple whose top two floors are completely covered in gold leaf. Originally built in 1397 as a shogun's retirement villa.",
            "opening_hours": "09:00",
            "closing_hours": "17:00",
            "best_time": "Late Morning 09:00-11:00",
            "description": "A stunning golden temple reflected in a serene pond surrounded by meticulously maintained gardens.",
            "slot": "morning",
            "lat": 35.0394,
            "lon": 135.7292,
        },
        {
            ...
            "history": "A natural bamboo forest with towering stalks creating an ethereal walking path. One of Kyoto's most photographed spots.",
            "opening_hours": "08:30",
            "closing_hours": "17:00",
            "best_time": "Early Morning 08:30-10:00",
            "description": "A surreal path through towering bamboo stalks that sway and creak in the wind, filtering sunlight into a green glow.",
            "slot": "morning",
            "lat": 35.0171,
            "lon": 135.6713,
        },
        {
            ...
            "history": "Historic wooden temple perched on a hillside with a large veranda offering panoramic views. Founded in 778 AD and a UNESCO World Heritage site.",
            "opening_hours": "06:00",
            "closing_hours": "18:00",
            "best_time": "Afternoon 14:00-16:00",
            "description": "A massive wooden terrace built without nails, jutting out over a hillside with sweeping views of Kyoto and cherry blossoms below.",
            "slot": "afternoon",
            "lat": 34.9949,
            "lon": 135.7850,
        },
        {
            "name": "Nishiki Market",
            "history": "A vibrant five-block-long covered market known as 'Kyoto's Kitchen', featuring over 100 shops and stalls selling local specialties.",
            "opening_hours": "09:00",
            "closing_hours": "18:00",
            "best_time": "Midday 11:00-13:00",
            "description": "A lively covered market with narrow lanes packed with stalls offering fresh seafood, pickles, sweets, and Kyoto specialties.",
            "slot": "afternoon",
            "lat": 35.0055,
            "lon": 135.7685,
        },
        {
            "name": "Gion District",
            "history": "Kyoto's famous geisha district with preserved wooden machiya houses and teahouses where geiko and maiko entertain.",
            "opening_hours": "00:00",
            "closing_hours": "00:00",
            "best_time": "Evening 19:00-21:30",
            "description": "A historic entertainment district with cobblestone streets, traditional wooden buildings, and the chance to spot geiko in vibrant kimono.",
            "slot": "evening",
            "lat": 35.0048,
            "lon": 135.7750,
        },
        {
            ...
            "history": "Zen temple housing Japan's most famous rock garden — 15 carefully placed stones on a bed of white gravel. Built in 1450.",
            "opening_hours": "08:00",
            "closing_hours": "17:00",
            "best_time": "Morning 08:00-10:00",
            "description": "A minimalist Zen rock garden with fifteen moss-covered stones raked into perfect white gravel, inviting quiet contemplation.",
            "slot": "morning",
            "lat": 35.0342,
            "lon": 135.7183,
        },
        {
            ...
            "history": "A 2km stone path along a canal lined with hundreds of cherry trees. Named after philosopher Nishida Kitaro who meditated here.",
            "opening_hours": "00:00",
            "closing_hours": "00:00",
            "best_time": "Afternoon 14:00-16:30",
            "description": "A serene stone walkway following a cherry-tree-lined canal, especially magical during cherry blossom season.",
            "slot": "afternoon",
            "lat": 35.0221,
            "lon": 135.7932,
        },
        {
            "name": "Nijo Castle",
            "history": "A flatland castle built in 1603 as the Kyoto residence of the first Tokugawa Shogun. Famous for its 'nightingale floors' that chirp.",
            "opening_hours": "08:45",
            "closing_hours": "17:00",
            "best_time": "Morning 08:45-11:00",
            "description": "A magnificent castle with ornate interiors, beautiful gardens, and famously squeaky nightingale floors designed to detect intruders.",
            "slot": "morning",
            "lat": 35.0143,
            "lon": 135.7484,
        },
        {
            "name": "Pontocho Alley",
            "history": "Narrow lantern-lit alley along the Kamogawa River lined with traditional eateries and teahouses dating back to the 1600s.",
            "opening_hours": "17:00",
            "closing_hours": "23:00",
            "best_time": "Evening 19:00-21:30",
            "description": "A narrow atmospheric alley with glowing lanterns, traditional restaurants on wooden decks over the river, and geisha sightings.",
            "slot": "evening",
            "lat": 35.0058,
            "lon": 135.7713,
        },
...
def generate_mock_plan(
    ...
    for d in range(1, days + 1):
        ...
        if is_last:
            ...
            if not evening_acts:
                evening_acts.append("Dinner and evening stroll (Evening 19:00-21:00)")
        ...
        itinerary.append(
            {
                ...
                f"Moving between attractions via {['bus #205', 'subway Karasuma line', 'taxi (~¥1500)'][d % 3]}."
                if not is_last
                else "Transfer to airport/station.",
                "morning": morning_acts,
                "afternoon": afternoon_acts,
                "evening": evening_acts,
                "meals": meals,
                "logistics": ["Check in to hotel", "Pick up local SIM / pocket WiFi"]
                if d == 1
                else (["Check out from hotel", "Head to airport/train station"] if is_last else []),
                "weather": weather,
                "spots": spots,
    ...
    transport_options = [
        {
            "mode": "Bus",
            "description": f"City bus network covers all major attractions in {destination}",
            "fare": "¥230 per ride",
            "notes": "Day pass available for ¥600",
        },
        {
            "mode": "Subway",
            "description": f"Two subway lines connecting main districts in {destination}",
            "fare": "¥210-¥340 per ride",
            "notes": "IC cards accepted",
        },
        {
            "mode": "Taxi",
            "description": f"Taxis are readily available in central {destination}",
            "fare": "¥500-¥1,500 depending on distance",
            "notes": "Flag fall ¥500",
        },
    ]
    ...
    return {
        ...
        "days": days,
        "budget_level": budget,
        "overview": DESTINATION_OVERVIEWS.get(
            destination, f"A comprehensive {days}-day travel plan for {destination}."
        ),
        "monthly_weather": DESTINATION_WEATHERS.get(
            destination, f"Pleasant weather expected in {month} with moderate temperatures."
        ),
        "travel_month": month,
        "itinerary": itinerary,
        "practical_tips": [
        ...
        "citations": [
            {
                "title": f"{destination} Travel Guide — Lonely Planet",
                "url": f"https://www.lonelyplanet.com/{destination.lower()}",
            },
            {
                "title": f"Japan National Tourism — {destination}",
                "url": f"https://www.japan.travel/en/destinations/{destination.lower()}/",
            },
        ...
        "insights": {
            "route": {
                ...
                "cluster_advice": [
                    f"Group northern {destination} attractions together (Kinkaku-ji, Ryoan-ji)",
                ...
                "transit_notes": [
                    f"Use the {destination} bus network for most attractions; subway for longer distances",
            ...
            "budget": {
                ...
                "assumptions": [
                    f"Hotel costs estimated at ₹3,500-5,000 per night per room in {destination} budget hotels",
                ...
                "saving_tips": [
                    f"Eat at local markets and convenience stores in {destination} for budget meals",
            ...
            "timing": {
                ...
                "day_planning_notes": [
                    f"Start each day early in {destination} to beat the crowds at major temples",
        ...
        "live_web_brief": {
            ...
            "sources": [
                {
                    "title": f"{destination} Official Tourism",
                    "url": f"https://www.{destination.lower()}.travel/",
                    "kind": "web",
                },
            ],
        },
